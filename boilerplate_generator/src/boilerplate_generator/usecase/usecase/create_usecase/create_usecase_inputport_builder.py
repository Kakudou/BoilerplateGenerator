...
class CreateUsecaseInputPortBuilder:
    ...
    def create(self):
        ...
        Returns:
        --------
        CreateUsecaseInputPortBuilder
            this builder with the contract to fill

        """

        self.__input = CreateUsecaseInputPort()
        return self
    ...
    def with_name(self, name: str):
        ...
        -----------
        name: str
            the name of the CreateUsecase

        Returns:
        --------
        CreateUsecaseOutputPortBuilder
            this builder with the contract to fill
    ...
    def with_description(self, description: str):
        ...
        -----------
        description: str
            the description of the CreateUsecase
    ...
    def with_type_(self, type_: str):
        ...
        -----------
        type_: str
            the type_ of the CreateUsecase
    ...
    def with_entity_name(self, entity_name: str):
        ...
        -----------
        entity_name: str
            the entity_name of the CreateUsecase
    ...
    def with_project_name(self, project_name: str):
        ...
        -----------
        project_name: str
            the project_name of the CreateUsecase
    ...
    def with_input_attrs(self, input_attrs: List):
        ...
        -----------
        input_attrs: List
            the input_attrs of the CreateUsecase
    ...
    def with_output_attrs(self, output_attrs: List):
        ...
        -----------
        output_attrs: List
            the output_attrs of the CreateUsecase
    ...
    def build(self) -> CreateUsecaseInputPort:
        """ This function return the filled contract

        Returns:
        --------
        CreateUsecaseInputPort
            the contract filled
