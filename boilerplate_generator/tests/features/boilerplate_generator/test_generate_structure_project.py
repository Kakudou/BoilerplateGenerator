...
def then_generate_entity(context):
    try:
        ...
        assert os.path.exists(f"{dest_path}/generate_structure/constraints/tui")
        assert os.path.exists(f"{dest_path}/generate_structure/tests/constraints/tui")
        assert os.path.exists(f"{dest_path}/generate_structure/features/tui")
        assert os.path.exists(f"{dest_path}/generate_structure/tests/features/tui")
        assert os.path.exists(f"{dest_path}/generate_structure/src/app/tui")
        assert os.path.exists(f"{dest_path}/generate_structure/src/app/tui/entity_view")
        assert os.path.exists(f"{dest_path}/generate_structure/src/app/tui/view")
