...
class GenerateStructureProject:
    ...
    def execute(self, inputp: GenerateStructureProjectInputPort) -> GenerateStructureProjectOutputPort:
        ...
        folders = [
            ...
            f"{dest_path}/{project.snakename}/constraints/core",
            f"{dest_path}/{project.snakename}/features",
            f"{dest_path}/{project.snakename}/features/core",
            ...
            f"{dest_path}/{project.snakename}/src/core",
            f"{dest_path}/{project.snakename}/src/core/entity",
            f"{dest_path}/{project.snakename}/src/core/gateway",
            ...
            f"{dest_path}/{project.snakename}/tests/constraints/core",
            f"{dest_path}/{project.snakename}/tests/features",
            f"{dest_path}/{project.snakename}/tests/features/core",
        ]
        ...
        files = [
            ...
            f"{dest_path}/{project.snakename}/src/core/gateway/abstract_gateway.py",
