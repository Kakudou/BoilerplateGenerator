...
def then_generate_constraint(context):
    try:
        ...
        assert os.path.exists(f"{dest_path}/generate_constraint/constraints/cli/cli/generate_constraint.constraint")
        assert os.path.exists(f"{dest_path}/generate_constraint/tests/constraints/cli/cli/test_generate_constraint.py")
    finally:
