...
@dataclass
class ReadUsecaseOutputPortBuilder:
    ...
    def create(self):
        ...
        self.__output = ReadUsecaseOutputPort()
        return self
    ...
    def with_description(self, description: str):
        ...
        -----------
        description: str
            the description of the ReadUsecase
    ...
    def with_entity_name(self, entity_name: str):
        ...
        -----------
        entity_name: str
            the entity_name of the ReadUsecase
    ...
    def with_input_attrs(self, input_attrs: List):
        ...
        -----------
        input_attrs: List
            the input_attrs of the ReadUsecase
    ...
    def with_output_attrs(self, output_attrs: List):
        ...
        -----------
        output_attrs: List
            the output_attrs of the ReadUsecase
    ...
    def build(self) -> ReadUsecaseOutputPort:
