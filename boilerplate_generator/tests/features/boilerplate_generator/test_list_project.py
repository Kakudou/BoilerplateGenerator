...
def given_list_project(context):
    context["project1"] = Factory.create_project("ListProject1")
    CreateProjectAdapter.execute(context["project1"], STORAGE_ENGINE)
    context["project2"] = Factory.create_project("ListProject2")
    CreateProjectAdapter.execute(context["project2"], STORAGE_ENGINE)
    context["project3"] = Factory.create_project("ListProject3")
