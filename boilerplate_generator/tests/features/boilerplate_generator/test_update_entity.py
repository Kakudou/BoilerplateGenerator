...
def given_update_entity(context):
    context["project"] = Factory.create_project("UpdateEntity")
    CreateProjectAdapter.execute(context["project"], STORAGE_ENGINE)
    context["entity"] = Factory.create_entity("UpdateEntity")
...
def when_update_entity(context):
    ...
    context["entity"]["when"] = "changed"
    context["entity"]["then"] = "changed"
