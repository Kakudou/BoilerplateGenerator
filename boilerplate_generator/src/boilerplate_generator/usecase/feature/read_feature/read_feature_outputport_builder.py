...
@dataclass
class ReadFeatureOutputPortBuilder:
    ...
    def create(self):
        ...
        self.__output = ReadFeatureOutputPort()
        return self
    ...
    def with_description(self, description: str):
        ...
        -----------
        description: str
            the description of the ReadFeature
    ...
    def with_scenario(self, scenario: str):
        ...
        -----------
        scenario: str
            the scenario of the ReadFeature
    ...
    def build(self) -> ReadFeatureOutputPort:
