...
class UpdateFeatureInputPortBuilder:
    ...
    def create(self):
        ...
        Returns:
        --------
        UpdateFeatureInputPortBuilder
            this builder with the contract to fill

        """

        self.__input = UpdateFeatureInputPort()
        return self
    ...
    def with_project_name(self, project_name: str):
        ...
        -----------
        project_name: str
            the project_name of the UpdateFeature
    ...
    def with_domain(self, domain: str):
        ...
        -----------
        domain: str
            the domain of the UpdateFeature
    ...
    def with_description(self, description: str):
        ...
        -----------
        description: str
            the description of the UpdateFeature
    ...
    def with_scenario(self, scenario: str):
        ...
        -----------
        scenario: str
            the scenario of the UpdateFeature
    ...
    def with_given(self, given: str):
        ...
        -----------
        given: str
            the given of the UpdateFeature
    ...
    def build(self) -> UpdateFeatureInputPort:
        """ This function return the filled contract

        Returns:
        --------
        UpdateFeatureInputPort
            the contract filled
