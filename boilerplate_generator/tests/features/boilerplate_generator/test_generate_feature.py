...
def then_generate_feature(context):
    try:
        ...
        assert os.path.exists(f"{dest_path}/generate_feature/features/cli/cli/generate_feature.feature")
        assert os.path.exists(f"{dest_path}/generate_feature/tests/features/cli/cli/test_generate_feature.py")
    finally:
